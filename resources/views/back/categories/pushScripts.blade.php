...
<script>
    $(document).ready(function() {
                ...
                success: function(data) {
                    ...
                    if (data && data['failed']) {
                        ...
                        setTimeout(function() {
                            ...
                            let categoriesIndexUrl = "{{ route('back.categories.index') }}";
                            $("#mainCont").load(categoriesIndexUrl + " #mainCont > *");
                        }, 1000);
                    }
                },
        ...
        $(document).on('click', ".deleteClass", function(e) {
            ...
            // Show delete modal using Bootstrap 5
        ...
        $(document).on('click', "#submit_delete", function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    setTimeout(function() {
                        let categoriesIndexUrl = "{{ route('back.categories.index') }}";
                        window.location.href = categoriesIndexUrl;
                    }, 1000);
                },
                error: function(xhr, status, error){
