    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('back.profile.update') }}" id="profile-form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('back.profile.password.update') }}" id="password-form">
                        @csrf
                        @method('PUT')
