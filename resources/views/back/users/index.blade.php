        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a href="{{ route('back.users.create') }}" data-title="{{ __('lang.add_new_user') }}" id="add_btn" class="btn btn-primary" data-toggle="modal" data-target="#mainModal">
                        {{ __('lang.add_new') }}
                    </a>
                </div>
                @endif
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="{{ route('back.users.show', ['user' => $item]) }}" class="dropdown-item displayClass" data-title="{{ __('lang.show_user') }}" data-toggle="modal" data-target="#mainModal">
                                                ...
                                                <a href="{{ route('back.users.edit', ['user' => $item]) }}" class="dropdown-item editClass" data-title="{{ __('lang.edit_user') }}" data-toggle="modal" data-target="#mainModal">
                                                ...
                                                <a class="dropdown-item deleteClass" href="{{ route('back.users.destroy', ['user' => $item]) }}" data-title="{{ __('lang.delete_user') }}" data-toggle="modal" data-target="#deleteModal">
