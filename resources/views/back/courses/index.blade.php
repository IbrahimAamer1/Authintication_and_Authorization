...
@section('content')
    @include('components.tables.table-header', [
        ...
        'createRoute' => route('back.courses.create'),
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @include('components.tables.table-actions', [
                                            'item' => $course,
                                            'showRoute' => route('back.courses.show', ['course' => $course]),
                                            'editRoute' => route('back.courses.edit', ['course' => $course]),
                                            'deleteRoute' => route('back.courses.destroy', ['course' => $course]),
