...
@section('content')
    @include('components.tables.table-header', [
        ...
        'createRoute' => route('back.lessons.create'),
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @include('components.tables.table-actions', [
                                            'item' => $lesson,
                                            'showRoute' => route('back.lessons.show', ['lesson' => $lesson]),
                                            'editRoute' => route('back.lessons.edit', ['lesson' => $lesson]),
                                            'deleteRoute' => route('back.lessons.destroy', ['lesson' => $lesson]),
