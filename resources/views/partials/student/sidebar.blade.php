...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- My Courses -->
        <li class="menu-item @yield('my_courses_active', '')">
            <a href="{{ route('student.my-courses') }}" class="menu-link">
        ...
        <li class="menu-item @yield('courses_active', '')">
            <a href="{{ route('student.courses.index') }}" class="menu-link">
                ...
                <div data-i18n="Browse Courses">Browse Courses</div>
            </a>
        </li>

        <!-- Certificates -->
        <li class="menu-item @yield('certificates_active', '')">
            <a href="{{ route('student.certificates.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-certificate"></i>
                <div data-i18n="Certificates">Certificates</div>
            </a>
        </li>

        <!-- Progress -->
        <li class="menu-item @yield('progress_active', '')">
            <a href="{{ route('student.progress.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-bar-chart"></i>
                <div data-i18n="Progress">My Progress</div>
            </a>
        </li>
    </ul>
</aside>
